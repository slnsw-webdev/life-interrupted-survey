...
$(document).ready(function () {
	...
	$("#msform .multiple-button").click(function () {
		if ($(this).attr("name") == "q3btn" && $(this).val() == "Other") {
			$("#q3detailscontainer").show();
		}
	});

	$("#msform .multiple-button").click(function () {
		if ($(this).attr("name") == "q5btn" && $(this).val() == "Other") {
			$("#q5detailscontainer").show();
		}
	});	

	$("#msform .multiple-button").click(function () {
		if ($(this).attr("name") == "q6btn" && $(this).val() == "Other") {
			$("#q6detailscontainer").show();
		}
	});		
	...
	$("#msform .multiple-button").click(function () {
		if ($(this).attr("name") == "q12abtn" && $(this).val() == "Other") {
			$("#q12adetailscontainer").show();
		}
	});
	...
	// Attach a submit handler to the main survey form
	...
	// Attach a submit handler to the confirmation page
